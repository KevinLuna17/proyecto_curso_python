...
# Conexion a una base de datos SQL por medio del ORM SQL Alchemy.
...
class SQLAlchemyClient:
    ...
    def __init__(self):
        ...
        # Obtener el host o el socket. Solo se usa uno de los dos para la conexion.
        # El socket es util para conectarse con una base de datos en GCP.
