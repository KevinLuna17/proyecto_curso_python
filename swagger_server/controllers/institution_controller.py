...
# El metodo (MethodView) permite en el constructor init instanciar el pool de conexiones y asi no abrir conexion en cada peticion a la base
# lo que estariamos haciendo es que solo abrimos conexion una vez y es cuando instanciamos el Docker

# Para que todos los metodos pertenezcan a la clase se debe dar un TAB y agregar self
